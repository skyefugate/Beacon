...
class TestCaptureEnvironment:
    ...
    def test_capture_environment_success(self, mock_public_ip, mock_gateway, mock_platform, mock_socket, mock_psutil):
        # Mock platform info
    ...
    @patch("beacon.evidence.environment._detect_gateway")
    @patch("beacon.evidence.environment._detect_public_ip")
    def test_capture_environment_interface_exception(self, mock_public_ip, mock_gateway, mock_platform, mock_socket, mock_psutil):
        # Mock basic info
        mock_platform.system.return_value = "Linux"
        mock_platform.release.return_value = "5.4.0"
        mock_platform.machine.return_value = "x86_64"
    ...
    @patch("beacon.evidence.environment._detect_gateway")
    @patch("beacon.evidence.environment._detect_public_ip")
    def test_capture_environment_ipv4_only(self, mock_public_ip, mock_gateway, mock_platform, mock_socket, mock_psutil):
        mock_platform.system.return_value = "Linux"
        mock_platform.release.return_value = "5.4.0"
        mock_platform.machine.return_value = "x86_64"
        mock_platform.python_version.return_value = "3.11.0"
    ...
    @patch("beacon.evidence.environment._detect_gateway")
    @patch("beacon.evidence.environment._detect_public_ip")
    def test_capture_environment_no_ip_addresses(self, mock_public_ip, mock_gateway, mock_platform, mock_socket, mock_psutil):
        mock_platform.system.return_value = "Linux"
        mock_platform.release.return_value = "5.4.0"
        mock_platform.machine.return_value = "x86_64"
        mock_platform.python_version.return_value = "3.11.0"
