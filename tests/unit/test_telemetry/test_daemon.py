...
class TestDaemon:
    ...
    def test_build_scheduler(self):
        ...
        assert len(scheduler._samplers) == 10  # wifi, dhcp, tcp, nic, ping, dns, http, device, context, change
    ...
    def test_build_scheduler_sampler_names(self):
        ...
        assert names == {"wifi", "dhcp", "tcp", "nic", "ping", "dns", "http", "device", "context", "change"}
