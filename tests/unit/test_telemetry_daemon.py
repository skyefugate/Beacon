...
class TestReloadConfig:
    ...
    @patch("beacon.telemetry.daemon.logging")
    def test_reload_config_success(self, mock_logging, mock_get_settings, mock_reset, mock_settings):
        mock_scheduler = Mock()
...
class TestBuildScheduler:
    ...
    def test_build_scheduler_with_exporters(self, mock_file_exp, mock_influx_exp, mock_buffer, mock_scheduler, mock_settings):
...
class TestRun:
    ...
    def test_run_success(self, mock_asyncio_run, mock_remove_pid, mock_write_pid, mock_read_pid, mock_setup_logging, mock_get_settings, mock_settings):
        mock_get_settings.return_value = mock_settings
    ...
    def test_run_telemetry_disabled(self, mock_exit, mock_read_pid, mock_setup_logging, mock_get_settings, mock_settings):
    ...
    @patch("beacon.telemetry.daemon.read_pid")
    @patch("beacon.telemetry.daemon.sys.exit")
    def test_run_daemon_already_running(self, mock_exit, mock_read_pid, mock_setup_logging, mock_get_settings, mock_settings):
        mock_get_settings.return_value = mock_settings
    ...
    @patch("beacon.telemetry.daemon._remove_pid")
    @patch("beacon.telemetry.daemon.asyncio.run")
    def test_run_with_config_path(self, mock_asyncio_run, mock_remove_pid, mock_write_pid, mock_read_pid, mock_setup_logging, mock_get_settings, mock_settings):
        mock_get_settings.return_value = mock_settings
    ...
    @patch("beacon.telemetry.daemon._remove_pid")
    @patch("beacon.telemetry.daemon.asyncio.run")
    def test_run_exception_cleanup(self, mock_asyncio_run, mock_remove_pid, mock_write_pid, mock_read_pid, mock_setup_logging, mock_get_settings, mock_settings):
        mock_get_settings.return_value = mock_settings
        mock_read_pid.return_value = None
